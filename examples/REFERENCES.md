...
| `hertz_contact` | **READY** | Rigid-sphere normal-contact check against the stated Hertz law, gated by `tests/test_hertz_contact.py`; the example documents its coarse finite-block bias. Reference: K. L. Johnson, *Contact Mechanics*, Cambridge University Press (1985), ISBN `978-0-521-34796-9`. |
