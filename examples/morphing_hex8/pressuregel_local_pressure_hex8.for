...
C======================================================================
     ...
     &  JPROPS, NJPROP, PERIOD)
      ...
      DOUBLE PRECISION :: grad_mu(3), mu_gp
      DOUBLE PRECISION :: p_elem, p_old, R_p, K_pp, dp
      DOUBLE PRECISION :: detF_diag, Je_diag, phi_diag, det33d
      DOUBLE PRECISION :: P_real(3,3), rp_real
      DOUBLE PRECISION :: jR_real(3), cdot_real
      ...
      DOUBLE PRECISION :: drp_dF(3,3), drp_dp
      DOUBLE PRECISION :: drp_dmu
...
C     Assemble full x-p blocks, x = [u] (mechanical) or [u, mu] (gel)
      R_p = 0.0d0
      K_pp = 0.0d0
      DO kk = 1, ngp_out
...
C======================================================================
     ...
     &0.0d0) * phi)))
      mobility = ((DCMPLX(props(4), 0.0d0) * cR) / (DCMPLX(props(7),
     &0.0d0) * DCMPLX(props(8), 0.0d0)))
      CALL matvec33z(Cinv, grad_mu, MM4)

      DO ii = 1, 3
        jR_out(ii) = ((-mobility) * MM4(ii))
      END DO
...
C======================================================================
     ...
     &  dstorage_dF, dstorage_dp)
      ...
      DOUBLE PRECISION, INTENT(OUT) :: rp_real
      DOUBLE PRECISION, INTENT(OUT) :: jR_real(3)
      ...
      DOUBLE PRECISION, INTENT(OUT) :: drp_dp
      DOUBLE PRECISION, INTENT(OUT) :: drp_dmu
      ...
      DOUBLE COMPLEX :: muz, grad_mu_z(3)
      DOUBLE COMPLEX :: stress_z(3,3), rp_z
      DOUBLE COMPLEX :: J_inel_z
      DOUBLE COMPLEX :: flux_z(3), cdot_z
      INTEGER :: i, j, k, l
