...
C     ogden_umat.for
C
C     Generated by coupfe.codegen v0.2.0
...
C
C     Generated by coupfe.codegen for material: ogdenoneterm
C     NPROPS = 3
C======================================================================
...
C======================================================================
     ...
     &DCMPLX(3.000000000000000d+00, 0.0d0)))
      ...
      coefficient = ((DCMPLX(2.000000000000000d+00, 0.0d0) *
     &DCMPLX(props(1), 0.0d0)) / DCMPLX(props(2), 0.0d0))
      volumetric = (DCMPLX(props(3), 0.0d0) * LOG(J))
      ...
      ARR3(3,3) = (tau3 / lam(3))
      diagonal = ARR3
      CALL matmul33z(V, diagonal, MM4)
      CALL inv33z(V, INV5)
      CALL matmul33z(MM4, INV5, MM6)
      second_pk = MM6
      CALL matmul33z(F, second_pk, MM7)
...
C     Major symmetry is satisfied by construction.
      ...
      DO i = 1, 6
        DO j = i, 6
          DDSDDE(i,j) = c(voigt_i(i), voigt_j(i), voigt_i(j),
     &voigt_j(j))
