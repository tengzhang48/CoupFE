...
C======================================================================
C     coupfe_element_rk subroutine ? generated by coupfe.codegen (F-bar Quad4)
C     Material: MooneyRivlin
C     Fields: u
C     Element: Quad4, NDOFEL = 8, F-bar = ON
C======================================================================
...
C       CS tangent: A_iJkL = dP_bar/dFbar_kL
        CALL mooneyrivlin_cs_tangent_dPdF(
     &    Fbar, PROPS, Atang)
...
C======================================================================
      SUBROUTINE mooneyrivlin_stress_PK1(F, props, P_out)
      IMPLICIT NONE
      ...
      DOUBLE COMPLEX :: TR2(3,3)
      DOUBLE COMPLEX :: FinvT(3,3)
      DOUBLE COMPLEX :: TR3(3,3)
      DOUBLE COMPLEX :: MM4(3,3)
      DOUBLE COMPLEX :: C(3,3)
      DOUBLE COMPLEX :: MM5(3,3)
      DOUBLE COMPLEX :: MM6(3,3)
      DOUBLE COMPLEX :: FC(3,3)
      DOUBLE COMPLEX :: P1(3,3)
      DOUBLE COMPLEX :: P2(3,3)
      DOUBLE COMPLEX :: Pvol(3,3)
      DOUBLE COMPLEX :: J
      DOUBLE COMPLEX :: I1
      DOUBLE COMPLEX :: I2
      DOUBLE COMPLEX :: Jm23
      ...
      J = det33z(F)
      CALL inv33z(F, INV1)
      CALL transpose33z(INV1, TR2)
      FinvT = TR2
      CALL transpose33z(F, TR3)
      CALL matmul33z(TR3, F, MM4)
      C = MM4
      I1 = (C(1,1)+C(2,2)+C(3,3))
      CALL matmul33z(C, C, MM5)
      I2 = (DCMPLX(5.000000000000000d-01, 0.0d0) * ((I1 * I1) - (MM5(1,
     &1)+MM5(2,2)+MM5(3,3))))
      Jm23 = EXP((LOG(J) * ((-DCMPLX(2.000000000000000d+00, 0.0d0)) /
     &DCMPLX(3.000000000000000d+00, 0.0d0))))
      Jm43 = (Jm23 * Jm23)
      CALL matmul33z(F, C, MM6)
      FC = MM6
      P1 = (((DCMPLX(2.000000000000000d+00, 0.0d0) * DCMPLX(props(1),
     &0.0d0)) * Jm23) * (F - (((DCMPLX(1.000000000000000d+00, 0.0d0) /
     &DCMPLX(3.000000000000000d+00, 0.0d0)) * I1) * FinvT)))
      P2 = (((DCMPLX(2.000000000000000d+00, 0.0d0) * DCMPLX(props(2),
     &0.0d0)) * Jm43) * (((I1 * F) - FC) -
     &(((DCMPLX(2.000000000000000d+00, 0.0d0) /
     &DCMPLX(3.000000000000000d+00, 0.0d0)) * I2) * FinvT)))
      Pvol = ((((DCMPLX(2.000000000000000d+00, 0.0d0) / DCMPLX(props(3),
     & 0.0d0)) * (J - DCMPLX(1.000000000000000d+00, 0.0d0))) * J) *
     &FinvT)

      DO ii = 1, 3
        DO jj = 1, 3
          P_out(ii,jj) = ((P1(ii,jj) + P2(ii,jj)) + Pvol(ii,jj))
        END DO
      END DO

      RETURN
      END SUBROUTINE mooneyrivlin_stress_PK1


C======================================================================
C     Section 3: Complex-step tangent engine
C======================================================================
      SUBROUTINE mooneyrivlin_cs_tangent_dPdF(
     &  F, PROPS, dPdF)
      IMPLICIT NONE
...
C     CS_H = 1e-10: verified for this framework
     ...
     &          AIMAG(Pz(i,j)) / CS_H
      ...
      RETURN
      END SUBROUTINE mooneyrivlin_cs_tangent_dPdF
