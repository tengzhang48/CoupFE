...
C     Generated by coupfe.codegen for material: smallstrainj2
C     NPROPS = 4
C     NSTATV = 1
C======================================================================
...
C     (Pattern: Chester umat_simpleFeFp.for)
...
C======================================================================
     ...
     &dstrain, ep_old, dt, cutback_flag, props, sigma_new, ep_new)
      ...
      DOUBLE COMPLEX :: direction(3,3)
      DOUBLE COMPLEX :: seq
      DOUBLE COMPLEX :: yield_function
     ...
     &2)+MM5(3,3)))
      yield_function = (seq - (DCMPLX(props(3), 0.0d0) +
     &(DCMPLX(props(4), 0.0d0) * ep_old)))
      IF (DBLE(yield_function) .GT. 0.000000000000000d+00) THEN
      dgamma = (yield_function / ((DCMPLX(3.000000000000000d+00, 0.0d0)
     ...
     &sigma_trial(3,3)) / DCMPLX(3.000000000000000d+00, 0.0d0)) * EYE6
      direction = (DCMPLX(1.500000000000000d+00, 0.0d0) / (seq +
     &DCMPLX(1.000000000000000d-30, 0.0d0))) * DEV7
      sigma_new = (sigma_trial - (((DCMPLX(2.000000000000000d+00,
     &0.0d0) * DCMPLX(props(1), 0.0d0)) * dgamma) * direction))
