...
C======================================================================
C======================================================================
C     coupfe_element_rk subroutine — generated by coupfe.codegen
C     Material: NeoHookean
C     Fields: u
C     Element: Quad4, NDOFEL = 8
C======================================================================
...
C     --- Tangent arrays ---
      ...
      INTEGER :: idx, ii_v, jj_v, i, j, k1, l, kk, row, col

C     Extract 2D coordinates from COORDS(MCRD, NNODE_E)
      DO ii_v = 1, NNODE_E
...
C     Carry state forward (updated per Gauss point if present)
      DO i = 1, NSVARS
...
C       Real material evaluation (for R)
        CALL real2complex33(F, Fz_r)
        CALL real2complex33(F_old, Fold_r)
        CALL neohookean_stress_PK1(Fz_r, PROPS, Pz_eval)
        DO i = 1, 3
          DO j = 1, 3
...
C       CS tangent engine
        CALL neohookean_cs_tangents(F, F_old, PROPS, dPK1_dF)

C       R assembly (weak-form signs)
        DO ii_v = 1, 4
          DO i = 1, ndim
            row = edof_u(i, ii_v)
            DO j = 1, ndim
...
C======================================================================
C     coupfe_element_r (residual-only twin) subroutine — generated by coupfe.codegen
C     Material: NeoHookean
C     Fields: u
C     Element: Quad4, NDOFEL = 8
C======================================================================
...
C======================================================================
      SUBROUTINE neohookean_cs_tangents(
     &   F, F_old, props, dPK1_dF)
...
C     === dPK1_dF: d(stress_PK1)/d(F) ===
      DO k = 1, 3
        DO l = 1, 3
          ...
          CALL neohookean_stress_PK1(Fz, props, PKz)
          DO i = 1, 3
            DO j = 1, 3
      ...
      RETURN
      END SUBROUTINE neohookean_cs_tangents
