...
C======================================================================
C     coupfe_element_r (residual-only twin) subroutine — generated by coupfe.codegen (F-bar Quad4)
C     Material: NeoHookean
C     Fields: u
C     Element: Quad4, NDOFEL = 8, F-bar = ON
C======================================================================
      SUBROUTINE coupfe_element_r(COORDS, U, DU, PROPS,
     &  SVARS_IN, R, SVARS_OUT, TIME, DTIME)
...
C     =============================================
C     Pass 2 (R-only): Fbar, material, R
C     =============================================
      DO kk = 1, NGP
        alpha = (Jbar / J_all(kk))
     &    ** (1.0d0 / DBLE(ndim))
...
C     End Pass 2
      ...
      RETURN
      END SUBROUTINE coupfe_element_r
