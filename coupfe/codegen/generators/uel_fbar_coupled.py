...
def _generate_uel_fbar_coupled(weakform, mat_prefix, cfg):
    ...
    # === SUBROUTINE HEADER ===
    lines.append('C======================================================================')
    lines.append('C     UEL subroutine — generated by coupfe.codegen (F-bar coupled)')
    ...
    # PASS 1: Compute centroid F0 and store per-GP data
    # =====================================================================
    # Centroid F-bar matches Shawn Chester's UEL and Datta & Nguyen (2025).
    ...
    # Shawn Chester and Datta & Nguyen both use centroid F-bar.
    ...
    # Deliberately disabled: Shawn Chester's reference UEL evaluates coupled
