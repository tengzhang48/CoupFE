...
flat ``mesh.inp`` file, then coupfe.codegen derives the UEL include files from
...
def _write_mesh_nodes_only(
    ...
    header = [
        "** =====================================================================\n",
        "** AUTO-GENERATED by coupfe.codegen. DO NOT EDIT.\n",
...
def _write_uel_scaffold(
    ...
    lines = ["** Generated by coupfe.codegen. Do not edit manually.\n"]
...
def write_job_inp(
    out_dir: Path,
    heading: str = "coupfe.codegen generated UEL job",
